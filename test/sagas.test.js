...
test('watchResourceListReadRequest', () => {
  ...
  expect(generator.next().value).toEqual(
    take(actions.RESOURCE_LIST_READ_REQUEST),
  );
  expect(generator.next({ payload, meta }).value).toEqual(
...
test('watchResourceDetailReadRequest', () => {
  ...
  expect(generator.next().value).toEqual(
    take(actions.RESOURCE_DETAIL_READ_REQUEST),
  );
  expect(generator.next({ payload, meta }).value).toEqual(
...
test('saga', () => {
  ...
  expect(generator.next().value).toEqual(
    fork(sagas.watchResourceCreateRequest, api),
  );
  expect(generator.next().value).toEqual(
    fork(sagas.watchResourceListReadRequest, api),
  );
  expect(generator.next().value).toEqual(
    fork(sagas.watchResourceDetailReadRequest, api),
  );
  expect(generator.next().value).toEqual(
    fork(sagas.watchResourceUpdateRequest, api),
  );
  expect(generator.next().value).toEqual(
    fork(sagas.watchResourceDeleteRequest, api),
  );
});
